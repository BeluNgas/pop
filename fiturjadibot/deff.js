...
'./lib/game'
    ...
    const fdoc = { key: { participant: '0@s.whatsapp.net' }, message: { documentMessage: { title: `【DEFFBOTZ】`, jpegThumbnail: fs.readFileSync(`./foto/deff.jpg`) } } }
    const fvn = { key: { participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) }, message: { "audioMessage": { "mimetype": "audio/ogg; codecs=opus", "seconds": 99999, "ptt": "true" } } }
    const fgif = { key: { participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) }, message: { "videoMessage": { "title": `【DEFFBOTZ】`, "h": `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': `【DEFFBOTZ】`, 'jpegThumbnail': fs.readFileSync(`./foto/deff.jpg`) } } }
    const fgclink = { key: { participant: "0@s.whatsapp.net", "remoteJid": "0@s.whatsapp.net" }, "message": { "groupInviteMessage": { "groupJid": "6288213840883-1616169743@g.us", "inviteCode": "m", "groupName": "P", "caption": `【DEFFBOTZ】`, 'jpegThumbnail': fs.readFileSync(`./foto/deff.jpg`) } } }
    const fvideo = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) }, message: { "videoMessage": { "title": `【DEFFBOTZ】`, "h": `Hmm`, 'seconds': '99999', 'caption': `【DEFFBOTZ】`, 'jpegThumbnail': fs.readFileSync(`./foto/deff.jpg`) } } }
...
participant: `0@s.whatsapp.net`, ...(from ? {
  remoteJid: "6289523258649-1604595598@g.us"
    ...
    }, message: { "orderMessage": { "orderId": "174238614569481", "thumbnail": fs.readFileSync(`./foto/deff.jpg`), "itemCount": 10, "status": "INQUIRY", "surface": "CATALOG", "message": `【DEFFBOTZ】`, "token": "AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA==" } }
...
if (budy.length > 1200) {
  ...
  setTimeout(() => {
    ...
    /*if (isSimi && isCmd) {
simi = await fetchJson(`https://api.lolhuman.xyz/api/simi?apikey=Deffbotz&text=${cmd}`)
sami = simi.result
...
│✙ Mnc : ${mnc}
│✙ Versi OS : ${os_version}
│✙ Browser : ${deff.browserDescription}
│┗ ━━┅━━━┅━━ 
└─────────────────┈ ⳹
\`\`\`\
 `
  buttons = [{ buttonId: `${prefix}command`, buttonText: { displayText: '❐List Menu' }, type: 1 }, { buttonId: `${prefix}rules`, buttonText: { displayText: '𖤍RulesBot' }, type: 1 },{ buttonId: `${prefix}changelog`, buttonText: { displayText: 'CHANGELOG' }, type: 1 },{ buttonId: `${prefix}command`, buttonText: { displayText: '☰ Command' }, type: 1 },{ buttonId: `${prefix}command`, buttonText: { displayText: '☰ Command' }, type: 1 },]
...
case 'command':
  ...
  stod = `${sender}`
  listMsg = {
    buttonText: 'Hello ${pushname} Pls select the menu here',
    footerText: '©DEFFBOTZ',
...
"rowId": "/soundmenu"
  ...
  break
  case'gay':
  reply(`njirr si ${pushname} gay,lari cukk ada gayyy`)
  break
  
///Batas list menu case
case 'kerangmenu':
  sendButLocation(from, kerangmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'rules':
  ...
  case 'help':
    ...
    break
case 'downloadmenu':
  sendButLocation(from, downloadmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'animemenu':
  sendButLocation(from, animemenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'tembakmenu':
  sendButLocation(from, tembakmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'othermenu':
  sendButLocation(from, othermenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'grupmenu':
  sendButLocation(from, grupmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
  case 'asupanmenu':
  sendButLocation(from, asupanmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
  case 'randomtag':
  sendButLocation(from, randomtag(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
  case 'primbonmenu':
  sendButLocation(from, primbonmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'randomimage':
  sendButLocation(from, randomimage(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'gamemenu':
  sendButLocation(from, gamemenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
  case 'nulismenu':
  sendButLocation(from, nulismenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
  case 'animanga':
  sendButLocation(from, animanga(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'anon':
  sendButLocation(from, anonymous(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'rpgmenu':
  sendButLocation(from, rpgmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'soundmenu':
  sendButLocation(from, soundmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
  case 'stickermenu':
  sendButLocation(from, stickermenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: Rfake }, [{ buttonId: `#}command`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
  case 'textgenerator':
  sendButLocation(from, textgenerator(prefix, botName), `Make by | Deff `, { jpegThumbnail:await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'editormenu':
  sendButLocation(from, editormenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'koreamenu':
  sendButLocation(from, koreamenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'coganmenu':
  sendButLocation(from, coganmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'cecanmenu':
  sendButLocation(from, cecanmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: 'back' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'convertmenu':
  sendButLocation(from, convertmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'searchmenu':
  sendButLocation(from, searchmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'randomvideo':
  sendButLocation(from, randomvideo(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'mememaker':
  sendButLocation(from, mememaker(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'kartunmenu':
  sendButLocation(from, kartunmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'randomtext':
  sendButLocation(from, textrandom(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'stalkmenu':
  sendButLocation(from, stalkmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'hewanmenu':
  sendButLocation(from, hewanmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'sertimenu':
  deff.sendMessage(from, sertimenu(prefix), MessageType.text, { quoted: ftroli })
  break
case 'infomenu':
  sendButLocation(from, infomenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'filmmenu':
  deff.sendMessage(from, filmmenu(prefix), MessageType.text, { quoted: ftroli })
  break
case 'islammenu':
  sendButLocation(from, islammenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'ephotooxy':
  sendButLocation(from, ephotooxy(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'ephoto360':
  sendButLocation(from, ephoto360(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'funmenu':
  sendButLocation(from, funmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'makermenu':
  sendButLocation(from, makermenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'apkmenu':
  sendButLocation(from, apkmenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
case 'ownermenu':
  sendButLocation(from, ownermenu(prefix, botName), `Make by | Deff `, { jpegThumbnail: await getBuffer(`https://api.zacros.my.id/asupan/cecan `) }, [{ buttonId: `#gay`, buttonText: { displayText: '\ngw gay nih ada yg mau gk?' }, type: 1 }], { contextInfo: { mentionedJid: [senderr,] } })
  break
...
case 'freefire':
  ...
  buttons = [{ buttonId: `#gay`, buttonText: { displayText: `BACK MENU` }, type: 1 }]
  imageMsg = (await deff.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
  buttonsMessage = {
    footerText: watermark, imageMessage: imageMsg,
    contentText: `©WhatsApp bot`, buttons, headerType: 4
...
"hydratedFourRowTemplate": {
  ...
  "hydratedFooterText": "Debug Make by | Deff ",
  "hydratedButtons": [
    {
"urlButton": {
...
case 'blackpinkk':
  ...
  imageMsg = (await deff.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
  buttonsMessage = {
    footerText: 'Make by | Deff ', imageMessage: imageMsg,
    contentText: `©WhatsApp bot`, buttons, headerType: 4
  }
  prep = await deff.prepareMessageFromContent(from, { buttonsMessage }, { quoted: ftroli })
  deff.relayWAMessage(prep)
...
case 'cecanindo':
  ...
  imageMsg = (await deff.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
  buttonsMessage = {
    footerText: 'DEFFBOTZ❤Make by | Deff  ', imageMessage: imageMsg,
    contentText: `©WhatsApp bot`, buttons, headerType: 4
  }
  prep = await deff.prepareMessageFromContent(from, { buttonsMessage }, { quoted: ftroli })
  deff.relayWAMessage(prep)
...
roar = args.join(" ")
  anu = await fetchJson(`https://api.lolhuman.xyz/api/${command}?apikey=Deffbotz&text=${roar}`)
  reply(anu.result)
  break
  ...
  case 'namaninja':
    if (args.length < 1) return reply(`Contoh:teks`)
    tess = args.join(" ")
anu = await fetchJson(`https://api.lolhuman.xyz/api/ninja?apikey=Deffbotz&nama=${tess}`)
reply(anu.result)
break
case 'chord':
  if (args.length < 1) return reply(`Example: ${prefix + command} duka`);
  roarr = args.join(" ")
    var res = await fetchJson(`https://api-xcoders.xyz/api/search/chordlagu?query=${roarr}&apikey=Deffbotz`);
    reply(mess.wait)
...
case 'ttp2':
  ...
  roadi = args.join(" ")
  if (args.length == 0) return reply(`Example: ${prefix + command} Deff`)
  buffer = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=Deffbotz&text=${roadi}`)
  deff.sendMessage(from, buffer, sticker, { quoted: freply })
  break
  case 'texttomorse':
    if (args.length < 1) return reply(`Contoh:teks`)
    roart = args.join(" ")
anu = await fetchJson(`https://api.lolhuman.xyz/api/morse/encrypt?apikey=Deffbotz&text=${roart}`)
reply(anu.result)
break
case 'morsetotext':
    if (args.length < 1) return reply(`Contoh: teks`)
    dpwm = args.join(" ")
anu = await fetchJson(`https://api.lolhuman.xyz/api/morse/decrypt?apikey=Deffbotz&text=${dpwm}`)
reply(anu.result)
break
...
case 'nightmare':
  ...
  if (args.length == 0) return reply(`Example: ${prefix + command} DEFF`)
  ini_txt = args.join(" ")
  buff = await getBuffer(`https://api.dapuhy.ga/api/photofunia/lightgraffiti?text=${command}&apikey=Deffbotz`)
  buttons = [{ buttonId: `!menu`, buttonText: { displayText: `BACK MENU` }, type: 1 }]
  imageMsg = (await deff.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
  buttonsMessage = {
    footerText: watermark, imageMessage: imageMsg,
...
case 'horor':
  case 'lucu':
    get_result = await fetchJson(`https://api-xcoders.xyz/api/random/cerpen/${command}?apikey=Deffbotz`)
    get_result = get_result.result
...
contentText: ini_txt, buttons, headerType: 4
    ...
    F = body.slice(8)              			    
    anu = await getBuffer(`https://kahfz-api.herokuapp.com/api/oxy/poly?text=${F}&apikey=Deffbotz`)
...
default:
  ...
  if (budy.includes("deff")) { //random sticker Make by | Deff , Hapus WM = yatim!
    data = stick
